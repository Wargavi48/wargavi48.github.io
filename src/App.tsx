...
function App() {
  ...
  return (
    <div className="flex flex-col min-h-[100dvh] dark:bg-gray-900" ref={homeRef}>
      ...
      <main className="flex-1 dark:text-gray-100">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <a href="https://x.com/wargavirtual48" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faXTwitter} size="lg" className="text-black dark:text-gray-100" />
                  </a>
                  <a href='https://tiktok.com/@wargavi48' target='_blank' rel='noopener noreferrer'>
                    <FontAwesomeIcon icon={faTiktok} size='lg' className='text-black dark:text-gray-100' />
                  </a>
                  <a href="https://store.steampowered.com/app/3037900/WGV_Dreamcatcher" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faSquareSteam} size="lg" className='text-[#1b2738] dark:text-gray-100' />
                  </a>
        ...
        <section id="about" className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800" ref={aboutRef}>
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-8 dark:text-gray-100">
              About Wargavi48
            </h2>
            <p className="mx-auto max-w-[700px] text-gray-700 md:text-xl text-center dark:text-gray-300">
        ...
        <section id="project" className="w-full py-12 md:py-24 lg:py-32 bg-muted dark:bg-gray-900" ref={projectRef}>
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-8 dark:text-gray-100">
              Project Wargavi48
            </h2>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t dark:bg-gray-900">
        <p className="text-xs text-muted-foreground dark:text-gray-100">&copy; 2024 Warga Virtual 48.</p>
      </footer>
    </div>
  )
}
